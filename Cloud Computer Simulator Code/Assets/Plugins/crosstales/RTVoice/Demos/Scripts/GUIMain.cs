...
namespace Crosstales.RTVoice.Demo
{
   ...
   public class GUIMain : MonoBehaviour
   {
      ...
      {
         Crosstales.RTVoice.Util.Helper.OpenURL(RTVoice.Util.Constants.ASSET_CT_URL);
      }

      public void OpenCTURL()
      {
         Crosstales.RTVoice.Util.Helper.OpenURL(RTVoice.Util.Constants.ASSET_AUTHOR_URL);
      }
